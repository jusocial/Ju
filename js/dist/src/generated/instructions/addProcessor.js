...
exports.createAddProcessorInstruction = exports.addProcessorInstructionDiscriminator = exports.addProcessorStruct = void 0;
const web3 = __importStar(require("@solana/web3.js"));
const beet = __importStar(require("@metaplex-foundation/beet"));
const beetSolana = __importStar(require("@metaplex-foundation/beet-solana"));
const ProcessorType_1 = require("../types/ProcessorType");
exports.addProcessorStruct = new beet.FixableBeetArgsStruct([
...
function createAddProcessorInstruction(accounts, args, programId = new web3.PublicKey('964vWgVEK9X8ZwZB2HyshFVmHUWbcYpRTnVYz2o3F2Xq')) {
    var _a;
    const [data] = exports.addProcessorStruct.serialize({
        instructionDiscriminator: exports.addProcessorInstructionDiscriminator,
        ...args,
    });
    const keys = [
        {
...
exports.createAddProcessorInstruction = createAddProcessorInstruction;
//# sourceMappingURL=addProcessor.js.map