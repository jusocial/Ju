...
exports.createInitializeAppInstruction = exports.initializeAppInstructionDiscriminator = exports.initializeAppStruct = void 0;
...
function createInitializeAppInstruction(accounts, args, programId = new web3.PublicKey('964vWgVEK9X8ZwZB2HyshFVmHUWbcYpRTnVYz2o3F2Xq')) {
    var _a;
    const [data] = exports.initializeAppStruct.serialize({
        instructionDiscriminator: exports.initializeAppInstructionDiscriminator,
        ...args,
    });
    const keys = [
        {
...
exports.createInitializeAppInstruction = createInitializeAppInstruction;
